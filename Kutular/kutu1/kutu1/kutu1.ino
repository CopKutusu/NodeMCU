...
double locationLatitude  = 40.770960;
double locationLongitude = 29.891243;
...
void loop()
{
  ...
  Serial.println(temperature);
    // Her seferinde baÅŸtan oluÅŸturulan data gÃ¶ndermek iÃ§in kullanÄ±lacak olan deÄŸiÅŸken
